...
#[must_use] pub fn bit_decompose(input: u64, num_var: usize) -> Vec<bool> {
...
#[must_use] pub fn create_uninit_vec<T: Sized>(len: usize) -> Vec<MaybeUninit<T>> {
...
#[inline(always)]
#[must_use] pub fn largest_even_below(n: usize) -> usize {
