...
impl<const M: usize, const C: usize, E: ExtensionField> AddSubConstants<UInt<M, C, E>> {
    ...
    /// carry     =  k  l   m  -
    /// |Carry| = |Cells|
    pub const N_CARRY_CELLS: usize = UInt::<M, C, E>::NUM_CELLS;
    ...
    pub const N_WITNESS_CELLS: usize = UInt::<M, C, E>::N_RANGE_CELLS + Self::N_CARRY_CELLS;
    ...
    pub const N_WITNESS_CELLS_NO_CARRY_OVERFLOW: usize =
        UInt::<M, C, E>::N_RANGE_CELLS + Self::N_CARRY_CELLS_NO_OVERFLOW;
    ...
    pub const N_RANGE_CELLS_NO_OVERFLOW: usize = UInt::<M, C, E>::N_RANGE_CELLS;
}
