...
Ceno's GKR layers invoke several sub-PIOPs, each discharging a specific
...
|---|---|---|---|
| [GKR for Tower Tree](./appendix/tower_tree.md) | Grand product $\prod_i a_i$ of $N = 2^d$ inputs | $d - 1$ | Input MLE $a$ at a single point $z \in B_d$ |
