...
use mpcs::{
    ...
    Basefold, BasefoldRSPoseidonParams, BasefoldSpec, EncodingScheme, PolynomialCommitmentScheme,
};
                    ...
                    b.iter(|| {
                        polys
                            ...
                            .map(|poly| {
                                ...
                                let mut codeword =
                                    <<BasefoldRSPoseidonParams as BasefoldSpec<E>>::EncodingScheme as EncodingScheme<E>>::encode(
                                        &pp.encoding_params,
                                        &coeffs,
                                    );
