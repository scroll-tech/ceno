...
impl<const M: usize, const C: usize> AddSubConstants<UIntV2<M, C>> {
    ...
    /// carry     =  k  l   m  -
    /// |Carry| = |Cells|
    pub const N_CARRY_CELLS: usize = UIntV2::<M, C>::N_OPERAND_CELLS;
    ...
    pub const N_WITNESS_CELLS: usize = UIntV2::<M, C>::N_RANGE_CELLS + Self::N_CARRY_CELLS;
    ...
    pub const N_WITNESS_CELLS_NO_CARRY_OVERFLOW: usize =
        UIntV2::<M, C>::N_RANGE_CELLS + Self::N_CARRY_CELLS_NO_OVERFLOW;
    ...
    pub const N_RANGE_CELLS_NO_OVERFLOW: usize = UIntV2::<M, C>::N_RANGE_CELLS;
}
