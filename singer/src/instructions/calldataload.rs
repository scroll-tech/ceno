...
mod test {
    ...
    fn test_calldataload_construct_circuit_helper<F: SmallField>() {
        ...
        phase0_values_map.insert("phase0_ts".to_string(), vec![F::BaseField::from(1u64)]);
    ...
    fn test_calldataload_construct_circuit() {
        test_calldataload_construct_circuit_helper::<GoldilocksExt2>();
    }
