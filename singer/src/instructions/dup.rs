...
mod test {
    ...
    fn test_dup1_construct_circuit_helper<F: SmallField>() {
        ...
        phase0_values_map.insert(
            "phase0_stack_ts_add".to_string(),
            vec![
                F::BaseField::from(3u64), // first TSUInt::N_RANGE_CHECK_CELLS = 1*(56/16) = 4 cells are range values, stack_ts + 1 = 4
    ...
    fn test_dup1_construct_circuit() {
        test_dup1_construct_circuit_helper::<GoldilocksExt2>()
    }
