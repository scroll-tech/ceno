...
mod test {
    ...
    impl MstoreAccessory {
        ...
        fn accessory_idxes_map() -> BTreeMap<String, Range<CellId>> {
            ...
            map.insert("pred_ooo_mem_bytes".to_string(), Self::pred_ooo_mem_bytes());
            map.insert(
            ...
            map.insert(
                "phase0_prev_mem_bytes".to_string(),
                Self::phase0_prev_mem_bytes(),
            );
    ...
    fn test_mstore_construct_circuit_helper<F: SmallField>() {
        ...
        {
            println!("MSTORE Instruction: {:?}", &phase0_idx_map);
