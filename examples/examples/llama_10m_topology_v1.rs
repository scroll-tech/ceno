//! Gate-5 32-layer fused-call topology reproducer.
//!
//! This deliberately exercises descriptor ordering and layer batching with the
//! existing reduced fused relations.  H160/FFN432 arithmetic is proved by the
//! separate K32 miniature relation and is not claimed by this guest yet.
