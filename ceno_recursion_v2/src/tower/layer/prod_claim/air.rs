...
impl<IB, OB> TowerProdSumCheckClaimAir<IB, OB> {
        ...
        Send: FnMut(&OB, &mut AB, AB::Var, TowerProdSumClaimMessage<AB::Expr>, AB::Expr),
    {
        ...
        // layer_idx correctness across layers is enforced by the bus
        // permutation argument (must match TowerLayerAir's layer_idx).
        ...
        ///////////////////////////////////////////////////////////////////////
        // Accumulator resets at layer start
        ///////////////////////////////////////////////////////////////////////
        ...
        ///////////////////////////////////////////////////////////////////////
        // p_xi interpolation (always constrained)
        ///////////////////////////////////////////////////////////////////////
        ...
        // Carry-forward within the same layer (is_within_layer = 1)
        assert_array_eq(
