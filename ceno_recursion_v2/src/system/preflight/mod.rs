...
pub struct PcsPreflight {
    ...
    pub jagged_assist_q: Vec<PcsJaggedAssistQRecord>,
...
#[derive(Clone, Debug, Default)]
pub struct PcsJaggedAssistQRecord {
    pub proof_idx: usize,
    pub round_idx: usize,
    pub sumcheck_idx: usize,
    ...
    pub rho_star_c: RecursionField,
    pub rho_star_d: RecursionField,
    pub term_acc_in: RecursionField,
    pub term_acc_out: RecursionField,
    pub q_acc_in: RecursionField,
    pub q_acc_out: RecursionField,
}
...
pub struct PcsBasefoldFinalExpectedRecord {
    ...
    pub is_first: bool,
    pub is_last: bool,
    pub is_elem_first: bool,
    pub is_elem_last: bool,
    pub has_challenge: bool,
    pub challenge_round: usize,
    pub point_value: RecursionField,
    pub bit_value: bool,
    pub challenge: RecursionField,
    pub final_value: RecursionField,
    pub coeff_in: RecursionField,
    pub coeff_out: RecursionField,
    pub acc_in: RecursionField,
    pub acc_out: RecursionField,
}
