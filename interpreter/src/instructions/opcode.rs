...
pub type Instruction<H, F> = fn(&mut Interpreter<F>, &mut H);

/// Instruction table is list of instruction function pointers mapped to
/// 256 EVM opcodes.
pub type InstructionTable<H, F> = [Instruction<H, F>; 256];

/// Arc over plain instruction table
pub type InstructionTableArc<H, F> = Arc<InstructionTable<H, F>>;

/// EVM opcode function signature.
pub type BoxedInstruction<'a, H, F> = Box<dyn Fn(&mut Interpreter<F>, &mut H) + 'a>;

/// A table of instructions.
pub type BoxedInstructionTable<'a, H, F> = [BoxedInstruction<'a, H, F>; 256];

/// Arc over instruction table
pub type BoxedInstructionTableArc<'a, H, F> = Arc<BoxedInstructionTable<'a, H, F>>;
...
pub enum InstructionTables<'a, H, F: SmallField> {
    Plain(InstructionTableArc<H, F>),
    Boxed(BoxedInstructionTableArc<'a, H, F>),
}

impl<'a, H, F: SmallField> Clone for InstructionTables<'a, H, F> {
    fn clone(&self) -> Self {
        match self {
...
pub fn make_boxed_instruction_table<'a, H, SPEC, FN, F: SmallField>(
    table: InstructionTable<H, F>,
    outer: FN,
) -> BoxedInstructionTable<'a, H, F>
where
    H: Host + 'a,
    SPEC: Spec + 'static,
    FN: Fn(Instruction<H, F>) -> BoxedInstruction<'a, H, F>,
{
...
opcodes! {
    ...
    0x63 => PUSH4  => stack::push::<4, H, F>,
    0x64 => PUSH5  => stack::push::<5, H, F>,
    0x65 => PUSH6  => stack::push::<6, H, F>,
    0x66 => PUSH7  => stack::push::<7, H, F>,
    0x67 => PUSH8  => stack::push::<8, H, F>,
    0x68 => PUSH9  => stack::push::<9, H, F>,
    0x69 => PUSH10 => stack::push::<10, H, F>,
    0x6A => PUSH11 => stack::push::<11, H, F>,
    0x6B => PUSH12 => stack::push::<12, H, F>,
    0x6C => PUSH13 => stack::push::<13, H, F>,
    0x6D => PUSH14 => stack::push::<14, H, F>,
    0x6E => PUSH15 => stack::push::<15, H, F>,
    0x6F => PUSH16 => stack::push::<16, H, F>,
    0x70 => PUSH17 => stack::push::<17, H, F>,
    0x71 => PUSH18 => stack::push::<18, H, F>,
    0x72 => PUSH19 => stack::push::<19, H, F>,
    0x73 => PUSH20 => stack::push::<20, H, F>,
    0x74 => PUSH21 => stack::push::<21, H, F>,
    0x75 => PUSH22 => stack::push::<22, H, F>,
    0x76 => PUSH23 => stack::push::<23, H, F>,
    0x77 => PUSH24 => stack::push::<24, H, F>,
    0x78 => PUSH25 => stack::push::<25, H, F>,
    0x79 => PUSH26 => stack::push::<26, H, F>,
    0x7A => PUSH27 => stack::push::<27, H, F>,
    0x7B => PUSH28 => stack::push::<28, H, F>,
    0x7C => PUSH29 => stack::push::<29, H, F>,
    0x7D => PUSH30 => stack::push::<30, H, F>,
    0x7E => PUSH31 => stack::push::<31, H, F>,
    0x7F => PUSH32 => stack::push::<32, H, F>,

    0x80 => DUP1  => stack::dup::<1, H, F>,
    0x81 => DUP2  => stack::dup::<2, H, F>,
    0x82 => DUP3  => stack::dup::<3, H, F>,
    0x83 => DUP4  => stack::dup::<4, H, F>,
    0x84 => DUP5  => stack::dup::<5, H, F>,
    0x85 => DUP6  => stack::dup::<6, H, F>,
    0x86 => DUP7  => stack::dup::<7, H, F>,
    0x87 => DUP8  => stack::dup::<8, H, F>,
    0x88 => DUP9  => stack::dup::<9, H, F>,
    0x89 => DUP10 => stack::dup::<10, H, F>,
    0x8A => DUP11 => stack::dup::<11, H, F>,
    0x8B => DUP12 => stack::dup::<12, H, F>,
    0x8C => DUP13 => stack::dup::<13, H, F>,
    0x8D => DUP14 => stack::dup::<14, H, F>,
    0x8E => DUP15 => stack::dup::<15, H, F>,
    0x8F => DUP16 => stack::dup::<16, H, F>,

    0x90 => SWAP1  => stack::swap::<1, H, F>,
    0x91 => SWAP2  => stack::swap::<2, H, F>,
    0x92 => SWAP3  => stack::swap::<3, H, F>,
    0x93 => SWAP4  => stack::swap::<4, H, F>,
    0x94 => SWAP5  => stack::swap::<5, H, F>,
    0x95 => SWAP6  => stack::swap::<6, H, F>,
    0x96 => SWAP7  => stack::swap::<7, H, F>,
    0x97 => SWAP8  => stack::swap::<8, H, F>,
    0x98 => SWAP9  => stack::swap::<9, H, F>,
    0x99 => SWAP10 => stack::swap::<10, H, F>,
    0x9A => SWAP11 => stack::swap::<11, H, F>,
    0x9B => SWAP12 => stack::swap::<12, H, F>,
    0x9C => SWAP13 => stack::swap::<13, H, F>,
    0x9D => SWAP14 => stack::swap::<14, H, F>,
    0x9E => SWAP15 => stack::swap::<15, H, F>,
    0x9F => SWAP16 => stack::swap::<16, H, F>,

    0xA0 => LOG0 => host::log::<0, H, F>,
    0xA1 => LOG1 => host::log::<1, H, F>,
    0xA2 => LOG2 => host::log::<2, H, F>,
    0xA3 => LOG3 => host::log::<3, H, F>,
    0xA4 => LOG4 => host::log::<4, H, F>,
    // 0xA5
    // 0xA6
    // 0xA7
    // 0xA8
